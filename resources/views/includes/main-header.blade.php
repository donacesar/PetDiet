                    ...
                    <div class="t228__right_buttons">
                        <div class="t228__right_buttons_wrap">
                            <div class="t228__right_buttons_but">
                                <a href="tel:{{ env('PHONE_LINK') }}" target="" class="t-btn js-click-stat" data-tilda-event-name="/tilda/click/rec433650632/button1" style="color:#2a2122;background-color:#f2f2f0;border-radius:20px; -moz-border-radius:20px; -webkit-border-radius:20px;">
